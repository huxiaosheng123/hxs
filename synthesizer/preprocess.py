...
def preprocess_speaker(speaker_dir, out_dir: Path, skip_existing: bool, hparams):
    ...
    for book_dir in speaker_dir.glob("*"):
        ...
        try:
            ...
            print('alignments_fpath',alignments_fpath)
        ...
        for wav_fname, words, end_times in alignments:
            print('wavfname',wav_fname)
            print('words',words)
            print('endtime',end_times)
...
def process_utterance(wav: np.ndarray, text: str, out_dir: Path, basename: str, 
    ...
    print('10101010101010', mel_spectrogram)
    print('10101010101010',mel_spectrogram.shape)
    ...
    print('wav3',wav)
    print('wav3', wav.shape)
    print('mel3',mel_spectrogram)
    print('mel3', mel_spectrogram.shape)
    print('text3',text)
    print('text3', len(text))
